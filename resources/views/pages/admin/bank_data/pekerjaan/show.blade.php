...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 col-xl-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-9">{{ $pekerjaan->judul }}</div>
                    </div>
                    ...
                    @if (auth()->user()->jenis == 'Kepala Sekolah' ||
                        ...
                        <button type="button" class="btn btn-sm btn-warning" data-toggle="modal"
                            ...
                            Ubah</button>
                        <form action="{{ route('pekerjaan.destroy', $pekerjaan->id) }}" class="d-inline" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    @include('pages.admin.bank_data.pekerjaan.edit')
