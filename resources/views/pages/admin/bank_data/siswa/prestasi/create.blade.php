<!-- Modal -->
<div class="modal fade modal-icon" id="addPrestasiSiswaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addPrestasiSiswaModalLabel">Tambah Prestasi Siswa</h5>
        ...
        <form action="{{ route('prestasiSiswa.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" id="judul" placeholder="Judul Prestasi" value="{{ old('judul') }}" required>
                    @error('judul')
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('tempat_kompetisi') is-invalid @enderror" placeholder="Surabaya" name="tempat_kompetisi" id="tempat_kompetisi" value="{{ old('tempat_kompetisi') }}" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control @error('tgl_kompetisi') is-invalid @enderror" placeholder="Tanggal Kompetisi" name="tgl_kompetisi" id="tgl_kompetisi" value="{{ old('tgl_kompetisi') }}" required>
                        @error('tgl_kompetisi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control @error('foto') is-invalid @enderror" name="foto" id="foto" type="file" placeholder="Foto Prestasi">
                ...
                <input class="form-control" name="id_siswa" id="id_siswa" type="hidden" value="{{ $id_siswa }}" readonly>
            </div>
