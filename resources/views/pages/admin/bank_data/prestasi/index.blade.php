                    ...
                    <tbody>
                        @foreach ( $prestasiSiswa as $prestasiSiswa )
                            <tr>
                                ...
                                <td>{{ $prestasiSiswa->siswaPrestasi->ppdbSiswa->nama }}</td>
                                <td>{{ $prestasiSiswa->kelasPrestasiSiswa->namaKelas->nama_kelas }}</td>
...
@include('pages.admin.bank_data.prestasi.create')
