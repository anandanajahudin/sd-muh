...
@section('title', 'Muhasabah Siswa | SekolahKarakter24')
            ...
            <div class="card-block table-border-style">
                <div class="table-responsive">
                    <table id="tabel" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($muhasabahSiswa as $user)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $user->siswa->kelasSiswa->namaKelas->nama_kelas }}</td>
                                    <td>{{ $user->siswa->ppdbSiswa->nama }}</td>
