...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-right mr-3">
            <a data-toggle="modal" data-target="#addKeunggulanModal">
                    ...
                    <tbody>
                        @foreach ( $keunggulan as $keunggulan )
                            <tr>
                                ...
                                <td>{{ $keunggulan->keterangan }}</td>
                                <td class="table-action" width="10%">
                                    <a href="{{ route('dataKeunggulan').'/'.$keunggulan->id }}" class="btn btn-primary btn-sm">
...
@include('pages.admin.landing.profil.keunggulan.create')
