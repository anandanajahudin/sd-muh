...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-right mr-3">
            <a data-toggle="modal" data-target="#addKurikulumModal">
                        ...
                        @foreach ( $kurikulum as $kurikulum )
                            <tr>
                                ...
                                <td class="table-action" width="10%">
                                    <a href="{{ route('dataKurikulum').'/'.$kurikulum->id }}" class="btn btn-primary btn-sm">
...
@include('pages.admin.landing.kurikulum.create')
