...
@section('title', 'Tambah Agenda | SekolahKarakter24')
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul"
                            id="judul" placeholder="Judul Agenda" value="{{ old('judul') }}" required>
                        @error('judul')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tgl_agenda') is-invalid @enderror"
                            name="tgl_agenda" id="tgl_agenda" value="{{ old('tgl_agenda') }}" required>
                        @error('tgl_agenda')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <input type="hidden" class="form-control @error('jenis') is-invalid @enderror" name="jenis"
                        id="jenis" value="agenda" readonly>
                    <input type="hidden" class="form-control @error('link_vidio') is-invalid @enderror" name="link_vidio"
                        id="link_vidio" readonly>
