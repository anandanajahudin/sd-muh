...
@section('title', 'Tambah Berita TV | SekolahKarakter24')
            ...
            <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('link_vidio') is-invalid @enderror"
                            name="link_vidio" id="link_vidio" placeholder="OEycjwiXYgA" value="{{ old('link_vidio') }}"
                            required>
                    ...
                    <input type="hidden" class="form-control @error('jenis') is-invalid @enderror" name="jenis"
                        id="jenis" value="tv" readonly>
                    <input type="hidden" class="form-control @error('tgl_agenda') is-invalid @enderror" name="tgl_agenda"
                        id="tgl_agenda" readonly>
