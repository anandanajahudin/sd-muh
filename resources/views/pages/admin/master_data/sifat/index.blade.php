...
@section('title', 'Master Sifat | SekolahKarakter24')
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-right mr-3">
            <a data-toggle="modal" data-target="#addSifatModal">
                        ...
                        @foreach ( $sifat as $sifat )
                            <tr>
                                ...
                                <td class="table-action" width="10%">
                                    <a href="{{ route('sifat').'/'.$sifat->id }}" class="btn btn-primary btn-sm">
...
@include('pages.admin.master_data.sifat.create')
