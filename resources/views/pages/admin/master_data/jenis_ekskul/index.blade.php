...
@section('title', 'Data Jenis Ekskul | SekolahKarakter24')
                            ...
                            <tr>
                                ...
                                @if(auth()->user()->jenis != 'siswa')
                                    <td class="table-action" width="10%">
                                        <a href="{{ route('jenisEkskul.dashboard.show', $jenis->id) }}" class="btn btn-primary btn-sm">
...
@include('pages.admin.master_data.jenis_ekskul.create')
