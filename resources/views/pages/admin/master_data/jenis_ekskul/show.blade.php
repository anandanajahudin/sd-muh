...
@section('title', 'Data Detail Jenis Ekskul | SekolahKarakter24')
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 col-xl-12">
                    ...
                    @if (auth()->user()->jenis == 'Kepala Sekolah' ||
                        ...
                        <form action="{{ route('jenisEkskul.dashboard.destroy', $jenis->id) }}" class="d-inline" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    @include('pages.admin.master_data.jenis_ekskul.edit')
