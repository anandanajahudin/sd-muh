    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addPpdbSiswaModalLabel">Tambah Data Calon Siswa</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control alphaonly @error('nama_wali') is-invalid @enderror" name="nama_wali" id="nama_wali" placeholder="Nama Lengkap Wali Murid" value="{{ old('nama_wali') }}">
                        @error('nama_wali')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
