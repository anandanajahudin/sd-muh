...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-right mr-3">
                ...
                <a href="{{ route('ppdbSiswa.daftarCalonSiswa', $id_ppdb) }}" class="btn btn-primary btn-round btn-sm mr-2">
                    Selengkapnya
                </a>
                            ...
                            @foreach ($ppdbSiswa as $ppdbSiswa)
                                <tr>
                                    ...
                                    <td class="table-action" width="10%">
                                        <a href="{{ route('ppdbSiswa') . '/' . $ppdbSiswa->id }}"
    ...
    @include('pages.admin.ppdb.detail.create')
