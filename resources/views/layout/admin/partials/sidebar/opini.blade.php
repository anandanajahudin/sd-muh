...
@if (auth()->user()->jenis != 'walimurid' && auth()->user()->jenis != 'siswageneral' && auth()->user()->jenis != 'gurugeneral')
<li>
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="active">
                    <a href="{{ route('dataOpini') }}">
                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                        <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Opini</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                </li>
                <li class="">
